 ...
 */
public class ValidateScriptMain implements CheckedConsumer<MarmotRuntime> {
	...
	public static final void main(String... args) throws Exception {
		...
		ValidateScriptMain cmd = new ValidateScriptMain();
	...
	public void accept(MarmotRuntime marmot) throws Exception {
		...
		if ( m_scriptFile != null ) {
			scriptEngine.validate(new File(m_scriptFile));
		}
		else {
			scriptEngine.validate(System.in);
		}
	}
}
